        ...
        <div class="row">
            <div class="col-md-offset-2 col-md-8">
                ...
                <asp:GridView ID="StudentsGridView" runat="server" CssClass="table table-bordered table-striped table-hover" 
                    AutoGenerateColumns="false" AllowPaging="true" PageSize="10" OnPageIndexChanging="StudentsGridView_PageIndexChanging" DataKeyNames="StudentID" OnRowDeleting="StudentsGridView_RowDeleting">
                    <Columns>
